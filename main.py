...
import sys
# ╔══════════════════════════════════════════════════════════════════╗
# ║  CREATOR: SIR XHUVO CODEX
# ║  TELEGRAN: https://t.me/+-dDQ-RJlfmwzZjJl
# ║  PERSONAL TELEGRAM: @SirShuvo09
# ╚══════════════════════════════════════════════════════════════════╝
...
REQUIRED_CHANNELS = ["@sirxhuvoxlike"]
GROUP_JOIN_LINK = "https://t.me/sirxhuvoxlike"
OWNER_ID = 5560112887
OWNER_USERNAME = "@SirShuvo09"
...
def call_api(region, uid):
    url = f"https://sir-xhuvo-codex-like.onrender.com/like?uid={uid}&server_name={region}"
    try:
